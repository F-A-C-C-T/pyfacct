...
class Logger(object):
    ...
    def init_root_logger(
        ...
        session_handler = RotatingFileHandler(filename=session_file, mode='a', maxBytes=2*1024*1024, backupCount=5, encoding='utf-8')
        info_handler = RotatingFileHandler(filename=info_file, mode='a', maxBytes=2*1024*1024, backupCount=5, encoding='utf-8')
        warning_handler = RotatingFileHandler(filename=warning_file, mode='a', maxBytes=2*1024*1024, backupCount=5, encoding='utf-8')
